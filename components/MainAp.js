          ...
          return (
            ...
            >
              ...
              <div style={{ 
                ...
                <span style={{ fontSize: '11px', fontWeight: '600', color: t.text }}>{col.title}</span>
                <span style={{ 
                  marginLeft: 'auto', 
                  fontSize: '10px', 
                  padding: '2px 6px', 
              ...
              {/* Column Content */}
              <div style={{ flex: 1, padding: '6px', minHeight: '150px', maxHeight: '400px', overflowY: 'auto' }}>
                {colAssets.length === 0 ? (
                  <div style={{ 
                    padding: '20px 10px', 
                    textAlign: 'center', 
                      ...
                      <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', minHeight: '200px', width: '100%' }}>
                        {selectedAsset.muxPlaybackId ? (
                          ...
                          <video 
                            ...
                            style={{ maxWidth: '100%', maxHeight: isMobile ? '280px' : '55vh', objectFit: 'contain', background: '#000', borderRadius: '8px' }}
                          >
