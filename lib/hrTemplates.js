...
5. WORKING HOURS & AVAILABILITY: Given the nature of media production, working hours are variable and project-driven. You agree to be available as reasonably required to meet shoot schedules, deadlines, and client deliverables — including early starts, late finishes, evenings, weekends, and travel as the work demands. A weekly rest day will be provided wherever the production schedule permits.
...
5. WORKING SCHEDULE: As an independent contractor, you retain discretion over how you organize your work. However, given the nature of media production, you agree to be available as reasonably required to meet shoot schedules, deadlines, and client deliverables — including early starts, late finishes, evenings, weekends, and travel as the work demands.
