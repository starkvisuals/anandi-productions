...
//   - Maternity Benefit Act, 1961 (scaled to "where applicable" — sub-10 proprietor)
...
//   - Digital Personal Data Protection Act, 2023 (consent + Aadhaar masking)
//   - Payment of Wages Act, 1936 (employee deduction limits noted)
//
// Business reality (per owner, Jan 2026): Anandi Productions is a sole
// proprietorship with fewer than 10 team members. PF, ESI, gratuity, and
// employer-side PT are NOT operated at this size. Most team members are
// engaged as independent contractors. Templates reflect this; statutory
// benefits are framed as "where required by applicable law" so they auto-
// scale if the Company grows past the thresholds.
//
// Clauses added for money-loss protection (review with a lawyer):
//   - Contractor 4.3 / explicit independent-contractor status (no PF/ESI/PT)
//   - 8.6(iii) equipment declared-value recovery (+ Annexure "B")
//   - 8.7 notice-shortfall liquidated damages
//   - 8.8 breach / termination-for-cause damages
//   - 8.9 LOSS OF WORK & REVENUE liquidated damages (client/payment loss)
//   - 19 DPDP Act consent + Aadhaar masking
//
...
// {{probationMonths}}, {{probationMonthlySalary}}, {{compensationClause}},
...
(iv) Acknowledge that media production is project- and deliverable-driven: pre-production, shoots, post-production, edits, and client delivery timelines routinely require extended, irregular, and unsocial hours, including long shoot days, night shoots, weekend work, and travel. The Contractor retains discretion over how they organize their work but agrees to be available as production schedules and deliverables reasonably require. Fees under Clause 4 are for the engagement as a whole and are not computed on an hourly basis, and no separate overtime is payable;
...
(a) The Independent Contractor shall receive a fixed remuneration of {{compensationClause}}, payable on or before the 10th of the following month, subject to applicable tax deductions at source (TDS) where required by law. The specific structure may be supplemented by a separate engagement letter or annexure;
...
4.3 INDEPENDENT CONTRACTOR STATUS: The parties expressly acknowledge and agree that the Contractor is engaged as an independent contractor and not as an employee of the Company. Accordingly, the Company shall not deduct or contribute Provident Fund (PF), Employees' State Insurance (ESI), gratuity, or Professional Tax (PT) on the Contractor's behalf, and the Contractor shall not be entitled to any employee benefits arising under such statutes. The Contractor is solely responsible for their own statutory registrations, contributions, insurance, and tax filings. The Company shall deduct Tax Deducted at Source (TDS) only where required under the Income Tax Act, 1961. Nothing in this Agreement shall be construed to create an employer-employee relationship, partnership, or joint venture between the parties.
...
(iii) Upon termination, the Contractor shall return all equipment, materials, and information (including any Confidential Information) provided by or accessed through the Company, in good working condition (normal wear and tear excepted). Where any Company equipment or property entrusted to the Contractor is lost, stolen, damaged beyond normal wear and tear, or not returned within seven (7) days of the last working day, the Contractor shall reimburse the Company the declared value of such item as recorded in the Equipment Handover Form (Annexure "B"), and the Company may recover such amount from any dues payable to the Contractor;
...
8.9 LIABILITY FOR LOSS OF WORK AND REVENUE:

(a) The Contractor acknowledges that the Company's business depends on the timely and quality delivery of work to its clients, and that the Contractor's conduct directly affects the Company's ability to retain clients and receive payment.

(b) If, at any time during the Engagement Period, the Contractor's failure to perform, delay, abandonment of assigned work, negligence, unauthorized absence, or materially deficient quality of work directly results in the Company (i) losing a client, project, or engagement, (ii) losing, forfeiting, or being required to refund any payment, fee, or revenue due or expected from a client, or (iii) incurring penalties, re-work costs, or compensation payable to a client, then the Contractor shall be liable to compensate the Company for such loss by way of liquidated damages.

(c) The quantum of such liquidated damages shall be a genuine pre-estimate of the Company's loss, which the parties agree shall be measured by reference to the value of the lost or refunded client engagement, payment, or revenue, together with any direct re-work, replacement, and recovery costs reasonably incurred by the Company. The parties agree that this represents a reasonable pre-estimate of loss and does not constitute a penalty within the meaning of Section 74 of the Indian Contract Act, 1872.

(d) The Company may recover such amount from any final settlement, unpaid remuneration, security deposit, reimbursements, or other dues payable to the Contractor, and the Contractor expressly consents to such recovery. Where the loss exceeds the amounts so recoverable, the Contractor shall pay the balance to the Company within thirty (30) days of written demand.

(e) This Clause is without prejudice to the Company's right to terminate for cause under Clause 8.3 and to pursue any additional remedies under Clauses 8.4 and 8.8.
...
The provisions of Clauses 5, 6, 7, 8.7, 8.8, and 8.9 shall survive the termination of this Agreement.
...
19. DATA PROTECTION & CONSENT

19.1 The Contractor consents to the Company collecting, storing, and processing the Contractor's personal data — including name, contact details, address, date of birth, emergency contact, Aadhaar number, PAN, bank account details, photograph, and signature — for the purposes of engagement administration, payments, statutory compliance, and the legitimate business interests of the Company, in accordance with the Digital Personal Data Protection Act, 2023 ("DPDP Act").

19.2 The Company shall use reasonable technical and organizational measures to keep such data secure, shall retain it only for as long as necessary for the above purposes or as required by law, and shall not disclose it to third parties except as required for payroll, statutory, audit, or legal purposes.

19.3 The Contractor may request access to, or correction of, their personal data by writing to {{companyEmail}}. The Contractor consents to the Company retaining a masked record of the Aadhaar number (last four digits) where full retention is not required.
...
ANNEXURE "B" — EQUIPMENT HANDOVER & DECLARED VALUE

The following Company equipment and property has been entrusted to the Contractor. The Contractor acknowledges receipt in good working condition and agrees that, if any item is lost, stolen, damaged beyond normal wear and tear, or not returned within seven (7) days of the last working day, the Contractor shall reimburse the Company the declared value shown below, recoverable from any dues payable to the Contractor (Clause 8.6(iii)).

  Sr. | Item Description                | Serial / ID        | Declared Value (₹)
  ----|---------------------------------|--------------------|-------------------
   1  | _______________________________ | __________________ | __________________
   2  | _______________________________ | __________________ | __________________
   3  | _______________________________ | __________________ | __________________
   4  | _______________________________ | __________________ | __________________

  Total Declared Value (₹): _______________________________

Contractor (received):              For {{companyLegalName}} (issued):
Name:  {{employeeName}}             Name:  {{companyOwner}}
Sign:  _______________________     Sign:  _______________________
Date:  _______________________     Date:  _______________________

(If no equipment is issued at the time of signing, write "NIL" across the table. A fresh Annexure "B" shall be completed whenever equipment is later issued.)
`;
...
2.2 The first two (2) months of employment shall be treated as a probation period. During the probation period, either party may terminate this Agreement by giving fifteen (15) days' written notice, and any agreed probation salary shall apply. Upon successful completion of probation, the notice period under Clause 8 shall apply.
...
(iii) Acknowledge that media production is project-driven and that pre-production, shoots, post-production, edits, and client delivery timelines routinely require work beyond standard hours, including long shoot days, night shoots, weekend work, and travel. While standard hours align with the Maharashtra Shops and Establishments Act (nine (9) hours per day, up to forty-eight (48) hours per week, with a weekly rest day), the Employee accepts that extended and irregular hours are an essential part of the role. Where extended hours are worked, the Company may provide compensatory time off in lieu, in accordance with Company policy;
...
(a) The Employee shall receive a fixed salary of {{compensationClause}}, payable on or before the 10th of the following month, subject to any tax deductions at source (TDS) required by law. The detailed salary structure (basic, HRA, conveyance, special allowance, etc.) shall be set out in the offer letter or salary annexure;

(b) Statutory schemes such as Provident Fund (EPF), Employee State Insurance (ESI), and Gratuity apply only where the Company crosses the relevant statutory employee thresholds. At the Company's current size (a sole proprietorship below those thresholds), such schemes are not operated and no related deductions are made; salary is paid in full subject only to TDS where required by law. Should the Company cross the applicable thresholds in future, it will comply with the relevant statutes;

(c) The Employee shall be entitled to leave and public holidays as set out in the Company's Handbook, subject to prior approval and project commitments;

(d) Any maternity, paternity, or other statutory leave applies only where mandated by applicable law for an establishment of the Company's size. The Company may otherwise grant such leave at its discretion on a goodwill basis;
...
(a) The Employee acknowledges that the Company's business depends on the timely and quality delivery of work to its clients, and that the Employee's conduct directly affects the Company's ability to retain clients and receive payment.

(b) If, at any time during the Employment Period, the Employee's failure to perform, delay, abandonment of assigned work, negligence, unauthorized absence, or materially deficient quality of work directly results in the Company (i) losing a client, project, or engagement, (ii) losing, forfeiting, or being required to refund any payment, fee, or revenue due or expected from a client, or (iii) incurring penalties, re-work costs, or compensation payable to a client, then the Employee shall be liable to compensate the Company for such loss by way of liquidated damages.

(c) The quantum of such liquidated damages shall be a genuine pre-estimate of the Company's loss, measured by reference to the value of the lost or refunded client engagement, payment, or revenue, together with any direct re-work, replacement, and recovery costs reasonably incurred by the Company. The parties agree that this represents a reasonable pre-estimate of loss and does not constitute a penalty within the meaning of Section 74 of the Indian Contract Act, 1872, subject to any limits on deduction from wages under the Payment of Wages Act, 1936.

(d) The Company may recover such amount from any final settlement, unpaid remuneration, reimbursements, or other dues payable to the Employee (to the extent permitted by the Payment of Wages Act, 1936), and the Employee expressly consents to such recovery. Where the loss exceeds the amounts so recoverable, the Employee shall pay the balance to the Company within thirty (30) days of written demand.
...
8.5 MATERNITY LEAVE: Where the Maternity Benefit Act, 1961 applies to the Company, eligible female team members shall be entitled to maternity leave in accordance with that Act. The Company being a sole proprietorship below the statutory employee threshold, statutory maternity benefit may not currently be mandatory; in such case the Company may, at its discretion, grant reasonable paid or unpaid maternity leave on a goodwill basis, subject to prior arrangement with management.

8.6 PATERNITY LEAVE: The Company may, at its discretion, grant up to five (5) days of paid paternity leave, to be availed within one (1) month of the birth of the child, subject to prior arrangement with management.
...
9.1 Salaries and fees are paid monthly on or before the 10th of the following month, subject to any tax deductions at source (TDS) required by law. The Company is a sole proprietorship and, at its current size, is not required to operate Provident Fund (PF), Employees' State Insurance (ESI), gratuity, or to deduct Professional Tax (PT) on behalf of independent contractors. Independent contractors are responsible for their own statutory registrations, contributions, insurance, and tax filings. Should the Company cross the applicable statutory thresholds in future, it will comply with the relevant statutes and notify team members accordingly.
...
19.4 LIABILITY FOR LOSS OF WORK & REVENUE: Team members are reminded that the Company's income depends on timely, quality delivery to clients. Where a team member's failure to perform, delay, abandonment of work, negligence, unauthorized absence, or deficient quality directly causes the Company to lose a client, project, or payment, or to refund or forfeit revenue, the team member shall be liable to compensate the Company by way of liquidated damages, as set out in their Employment Agreement or Independent Contractor Agreement (Clause 8.9). Such amounts may be recovered from dues payable to the team member, subject to applicable law.

19.5 EQUIPMENT: Company equipment entrusted to a team member that is lost, damaged beyond normal wear and tear, or not returned, shall be recoverable at the declared value recorded in the Equipment Handover Form, as set out in their agreement.
...
20.3 Full and final settlement (including any earned but unpaid salary or fees, and any amounts due, net of any dues, advances, equipment shortfalls, or damages recoverable under the team member's agreement) shall be processed within forty-five (45) days of the last working day. Gratuity and leave encashment apply only where required by the applicable statute.
...
4. COMPENSATION: {{compensationClause}}, subject to any tax deductions at source (TDS) required by law. Detailed salary structure will be provided separately.
5. NATURE OF WORK & HOURS: Media production is project-driven. Pre-production, shoots, post-production, edits, and client delivery timelines routinely require work beyond standard hours — including long shoot days, night shoots, weekend work, tight delivery deadlines, and travel. You acknowledge that such extended and irregular hours are an inherent and essential part of this role and agree to make yourself available as production schedules and deadlines require. Where extended hours are worked, the Company may provide compensatory time off in lieu, in accordance with Company policy. A weekly rest day will be provided wherever the production schedule permits.
6. PROBATION: Two (2) months from the Start Date. During probation, either party may terminate with fifteen (15) days' written notice, and the probation salary (if applicable) shall apply.
...
8. LEAVE: Leave entitlements are as set out in the Employee Handbook and are subject to prior approval and project commitments.
9. STATUTORY: At the Company's current size (a sole proprietorship), schemes such as Provident Fund (PF), ESI, and gratuity are not applicable, and no such deductions are made. Salary is paid in full, subject only to tax deductions at source (TDS) where required by law.
...
4. FEES: {{compensationClause}}, payable on or before the 10th of the following month, subject to TDS deduction under the Income Tax Act 1961.
5. NATURE OF ENGAGEMENT & SCHEDULE: This is a project- and deliverable-based engagement in media production. You retain discretion over how you organize your work, but you acknowledge that pre-production, shoots, post-production, edits, and client delivery timelines routinely require extended, irregular, and unsocial hours — including long shoot days, night shoots, weekend work, and travel — and you agree to be available as production schedules and deliverables require. Fees are for the engagement as a whole and are not computed on an hourly basis; no separate overtime is payable.
